...
DROP TABLE IF EXISTS submission_uploads_drive;

CREATE TABLE submission_uploads_drive (
  id TEXT PRIMARY KEY,
...
INSERT INTO submission_uploads_drive (
  id,
  submission_id,
  form_id,
  user_id,
...
ALTER TABLE submission_uploads_drive RENAME TO submission_uploads;
